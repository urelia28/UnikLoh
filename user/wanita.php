...
// Filter produk berdasarkan kategori 'wanita'
$query = "SELECT * FROM products WHERE category_id = '2-wanita'";
...
<head>
    ...
    <title>Wanita - UnikLoh</title>
    <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.1.1/css/all.min.css">
    <link rel="stylesheet" href="../css/wanita.css">
</head>
<body>
<script>
...
<body>
    ...
    <div class="hero">
        <img src="../img/foto2.png" alt="Hero Image">
    </div>
